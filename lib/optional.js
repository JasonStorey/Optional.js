...
Optional.prototype = {
    get: function get() {
        if (isNotPresent(this._value)) {
            throw new Error('optional is empty');
        }
        return this._value;
    },
    isPresent: function isPresent() {
        return !isNotPresent(this._value);
    },
    ...
    filter: function filter(predicate) {
        ...
        if (!isNotPresent(this._value) && predicate(this._value)) {
    ...
    map: function map(mapper) {
        ...
        return isNotPresent(mappedValue) ? new Optional() : new Optional(mappedValue);
    },
    flatMap: function flatMap(mapper) {
        ...
        if (isNotPresent(flatMappedValue) || isNotPresent(flatMappedValue.get)) {
    ...
    orElse: function orElse(other) {
        return isNotPresent(this._value) ? other : this._value;
    },
